...
>(({ className, children, hideDescription = false, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        "z-50 grid w-full max-w-lg gap-4 border bg-background p-6 shadow-lg sm:rounded-lg max-h-[90vh] overflow-y-auto",
    ...
    >
      {children}
      {/* Hidden description for accessibility when not explicitly provided */}
      {hideDescription && (
