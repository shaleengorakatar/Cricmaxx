      ...
      <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10">
        ...
        >
          ...
          <motion.div variants={buttonVariants} className="flex justify-center mt-4 px-4">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-yellow-500 to-amber-500 text-white border-0 hover:from-yellow-400 hover:to-amber-400 text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 h-auto font-semibold shadow-lg hover:shadow-xl transition-all w-full sm:w-auto max-w-lg"
