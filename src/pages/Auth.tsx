...
const Auth = () => {
  ...
  const { signUp, signIn, isAuthenticated, profile, loading: authLoading } = useAuth();
  ...
  // Skip auth loading for the login/signup page - users should see the form immediately
  // Auth state redirect will handle authenticated users via useEffect
