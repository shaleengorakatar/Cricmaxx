...
import SimplifiedDebtsPanel from "@/components/admin/SimplifiedDebtsPanel";
          ...
          <Tabs defaultValue="predictions" className="space-y-4 md:space-y-6">
            ...
            <div className="overflow-x-auto -mx-4 px-4 pb-2 scrollbar-hide">
              <TabsList className="inline-flex h-auto p-1 gap-1 bg-muted/50 rounded-lg min-w-max md:grid md:grid-cols-5 lg:grid-cols-9 md:w-full">
                ...
                <TabsTrigger value="contests" className="text-xs px-3 py-2 whitespace-nowrap data-[state=active]:bg-background">
                  Contests
                </TabsTrigger>
                ...
                <TabsTrigger value="debts" className="text-xs px-3 py-2 whitespace-nowrap data-[state=active]:bg-background">
                  Debts
                </TabsTrigger>
              </TabsList>
            </div>
